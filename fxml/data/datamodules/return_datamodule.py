...
from fxml.data.datasets.return_dataset import ReturnDataset


class ReturnDataModule(L.LightningDataModule):
    def __init__(
        self,
        data,
        labels,
    ...
    def setup(self, stage=None):
        ...
        self.train_dataset = ReturnDataset(
            data=self.data,
            labels=train_events,
        ...
        self.val_dataset = ReturnDataset(
            data=self.data,
            labels=val_events,
            sequence_length=self.sequence_length,
            features_cols=self.features,
