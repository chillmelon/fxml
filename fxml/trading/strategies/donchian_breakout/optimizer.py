...
from fxml.trading.strategies.donchian_breakout.donchian_breakout import (
    donchian_breakout,
)
...
def main():
    ...
    for lookback in lookbacks:
        signal = donchian_breakout(data, lookback)
        data["signal"] = signal
    ...
    print("=" * 80)
    print("Best Lookback", lookbacks[np.argmax(pfs)])
